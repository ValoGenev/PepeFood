...
import com.gegessen.controller.BucketController;
...
@ControllerAdvice(assignableTypes = BucketController.class)
public class BucketExceptionHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(BucketExceptionHandler.class);
    ...
    public ResponseEntity<ErrorMessage> handleUserNotFoundException(BucketNotFoundException exception) {
